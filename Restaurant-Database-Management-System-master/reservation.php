...
$no_of_ppl = htmlentities($_REQUEST['no_of_ppl']);		
$res_time = htmlentities($_REQUEST['res_time']);
$email = htmlentities($_SESSION["email"]);
$vip_id= htmlentities($_REQUEST['vip_id']);

$stmt = $con->prepare("insert into reservation (`res_date`,`no_of_ppl`,`res_time`,`email`,`vip_id`) values (?, ?, ?, ?, ?)");
$stmt->bind_param("sissi", $res_date, $no_of_ppl, $res_time, $email, $vip_id);
$stmt->execute();
